...
> LLM/에이전트용 Dist UI MVC·폰트 진입.
> 인덱스: `docs/README.md` · 룰: `ui-prefab-layout.mdc` · `ui-font.mdc`
> **일반 UI 스크립트를 쓰거나 고치기 전에 이 문서를 읽는다.** 인벤은 `docs/inventory/INVENTORY_UI.md`.
...
- `docs/inventory/INVENTORY_UI.md`

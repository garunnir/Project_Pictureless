...
> Family / Leaf / AnimVerb / Override. 컨트롤러는 동작 모름 · Override=thin: GEAR Terms · LOCOMOTION · `.cursor/rules/arm-anim-layers.mdc`. 총기 Leaf·`burst`: [`BN_BAKE.md`](BN_BAKE.md).
...
Catalog/WeaponPresentationCatalog
  ...
  │    └─ Overrides (Animator)       Visual/Anim/CharacterAnimator/Overrides/
...
| `Visual/Prefabs/Combat/` | 발사체 (`DistProjectile`) 등 | — |

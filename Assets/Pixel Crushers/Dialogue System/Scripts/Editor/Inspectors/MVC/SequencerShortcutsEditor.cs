...
namespace PixelCrushers.DialogueSystem
{
    ...
    public class SequencerShortcutsEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.HelpBox("You can optionally assign GameObjects referenced by firstName in sequencer commands here. This prevents having to search for them at runtime.", MessageType.None);

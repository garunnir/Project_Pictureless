...
namespace PixelCrushers.DialogueSystem
{
    ...
    public class UnityUITypewriterEffect : AbstractTypewriterEffect
    {
        ...
        {
            [Tooltip("Automatically scroll to bottom of scroll m_rect. Useful for long text. Works best with leftID justification. Make sure the text has a Content Size Fitter.")]

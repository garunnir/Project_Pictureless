...
static class SettingsHudTogglesPrefabPatch
{
    ...
    static void WireSettingsWindow(GameObject root, Transform graphicsPage)
    {
        ...
        window.Wire(
            ...
            root.transform.Find("Area_Body/Area_Categories/Btn_Game")?.GetComponent<Button>(),
            root.transform.Find("Area_Body/Area_Content/Page_Game")?.gameObject,
            root.transform.Find("Area_Body/Area_Content/Page_Game/Btn_Save")?.GetComponent<Button>(),
            root.transform.Find("Area_Body/Area_Content/Page_Game/Btn_Load")?.GetComponent<Button>(),

// ============================================================
// FloorVisibilityHiddenSetComputer — 후보 타일만 policy 판정해 숨김 집합 산출
// ============================================================
using System;
...
{
    public sealed class FloorVisibilityHiddenSetComputer
    {
        readonly PlayerFloorVisibilityPolicy _policy;
        readonly IMapModelReadOnly _model;

        public FloorVisibilityHiddenSetComputer(

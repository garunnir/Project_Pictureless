...
namespace PixelCrushers.DialogueSystem
{
    ...
    public class DialogueActor : MonoBehaviour
    {
        ...
        [Tooltip("Optional portrait. If unassigned, will use portrait of actor in m_database. This field allows you to assign a Texture.")]
        public Texture2D portrait;

        [Tooltip("Optional portrait. If unassigned, will use portrait of actor in m_database. This field allows you to assign a Sprite.")]
